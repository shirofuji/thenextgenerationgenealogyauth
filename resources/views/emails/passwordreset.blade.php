...
<div style="background:#8fc1e3;padding:10px;color:#000;">
	Greetings,
	<br/><br/>
	You have requested a password reset for your account, please use the following temporary password to login to your account:
	<br/><br/>
	<pre>{{ $token }}</pre>
	<br/><br/>
	Don't forget to change your password to a more secure one.
</div>
